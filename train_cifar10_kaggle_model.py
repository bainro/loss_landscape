...
trainset = torchvision.datasets.CIFAR10(root="cifar10", train=True, download=True, transform=preprocess_train)
testset = torchvision.datasets.CIFAR10(root="cifar10", train=False, download=True, transform=preprocess_test)

train_loader = torch.utils.data.DataLoader(trainset, batch_size=15000, shuffle=True, num_workers=2)
