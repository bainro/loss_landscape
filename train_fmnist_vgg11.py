...
train_loader = torch.utils.data.DataLoader(trainset, batch_size=3200, shuffle=True, num_workers=2)
test_loader = torch.utils.data.DataLoader(testset, batch_size=64, shuffle=False, num_workers=2)

net = torchvision.models.vgg11_bn(num_classes=10)
if use_cuda:
    net.cuda()
...
scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min',
    factor=0.1, patience=10000, threshold=0.0001, threshold_mode='abs')
